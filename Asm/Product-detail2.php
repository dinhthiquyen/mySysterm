...
<nav class="navbar navbar-fixed-top navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header" style="padding: 0; margin: 0;">
      <a  href="Home2.php"><img src="images/LTPlogo.png" style="padding: 0; margin: 0; height: 40px; width: 90px"></a>
    </div>
    <ul class="nav navbar-nav">
      <li class="active"><a href="Home2.pho">Home</a></li>
...
<div class="wallppaper">
    ...
    <div class="right">
      <div>
          ...
          <button class="btn btn-danger navbar-btn" onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Buy Now</button>
            <div id="id01" class="modal">
              <form class="modal-content animate">
                <div class="container">
                  <table>
                    <tr>
                      <td colspan="5"><img src="<?php echo $row["Image"]?>" style="height: 200px; width: 200px;"></td>
                      <td>
                    <table>
                      <tr>
                      ...
                      <tr>
                        <td>Ages: <?php echo $row["Age"]?></td>
                      </tr>
                      <tr>
                        <td>Origin:<?php echo $row["Origin"]?></td>
                      </tr>
                      <tr>
                        <td>Description: <p style="margin-top: 10px; margin-left: 90px;"><?php echo $row["Description"]?></p></td>
                      </tr>
                      <tr>
                        <td>
                        <button onclick="show()" style="width: 100px;">Buy Now</button>
                        </td>
                      </tr>
                    </table>
